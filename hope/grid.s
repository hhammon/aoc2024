...
# coords be initialized and populated with a pair of ints in each slot
# with the x-coordinate in the least significant part and the
# y-coordinate in the most significant part. Since this is a litte-
# endian architecture, the x-coordinate can be addressed at the lower part.
grid_find_all:
